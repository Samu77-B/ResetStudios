...
export function BlogMarquee() {
  const phrase =
    "HOLISTIC COACHING  /  ONLINE TRAINING  /  MIND & BODY  /  ";
        ...
        <div className="mx-auto mt-12 flex max-w-6xl flex-col items-start justify-between gap-10 px-5 md:flex-row md:items-end md:px-8">
          <div>
            ...
            <p className="mt-4 max-w-sm text-base leading-[1.5] text-white/75">
              Achieve your fitness and wellness goals with structured online
              coaching — book your session and start today.
            </p>
            <a
              href={SITE.bookUrl}
              target="_blank"
          ...
          <article className="w-full max-w-sm overflow-hidden bg-white">
            <div className="relative aspect-[16/10]">
              <Image
                ...
                alt="Reset Studios coaching session"
                fill
            ...
            <div className="px-5 py-5">
              ...
              <h3 className="mt-2 font-display text-xl text-ink">
                One-To-One Coaching Designed Around You
              </h3>
            </div>
          </article>
        </div>
