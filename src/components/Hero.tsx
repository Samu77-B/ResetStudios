  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex min-h-[70svh] flex-col items-center justify-center px-5 pb-14 pt-28 text-center md:min-h-[75svh]">
        ...
        <h1 className="animate-fade-up-delay font-display text-[clamp(2.6rem,8vw,5.5rem)] text-white">
          Train for <span className="text-lemon">Health</span>
          <br />
          Not Just Looks
        </h1>
        <p className="animate-fade-up-delay-2 mx-auto mt-6 max-w-md text-base leading-[1.5] text-white/85">
